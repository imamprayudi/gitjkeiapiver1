...
<div class="container-fluid mt-3">
  <div class="row g-3">
    ...
    <div class="col-md-3">
<div class="card shadow border-0" id="card_po_total">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_po_unread">
<div class="card-body text-center">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_po_read">
<div class="card-body text-center">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_po_reject">
<div class="card-body text-center">
...
<div class="container-fluid mt-3">
  <div class="row g-3">
    ...
    <div class="col-md-3">
<div class="card shadow border-0" id="card_poc_total">
<div class="card-body text-center">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_poc_unread">
<div class="card-body text-center">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_poc_read">
<div class="card-body text-center">
...
<div class="col-md-3">
<div class="card shadow border-0" id="card_poc_reject">
<div class="card-body text-center">
...
function openDetail(status)
{
    ...
    const p = encodeURIComponent(btoa(query.toString()));

    window.open("mailpodetail.php?p=" + p, "_blank");
}
...
document.getElementById("card_po_total")
    .addEventListener("click", () => openDetail("po_total"));

document.getElementById("card_po_unread")
    .addEventListener("click", () => openDetail("po_unread"));

document.getElementById("card_po_read")
    .addEventListener("click", () => openDetail("po_read"));

document.getElementById("card_po_reject")
    .addEventListener("click", () => openDetail("po_reject"));

document.getElementById("card_poc_total")
    .addEventListener("click", () => openDetail("poc_total"));

document.getElementById("card_poc_unread")
    .addEventListener("click", () => openDetail("poc_unread"));

document.getElementById("card_poc_read")
    .addEventListener("click", () => openDetail("poc_read"));

document.getElementById("card_poc_reject")
    .addEventListener("click", () => openDetail("poc_reject"));
