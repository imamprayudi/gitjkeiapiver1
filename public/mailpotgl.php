...
<!DOCTYPE html>
  ...
  <body>
    ...
    PURCHASE ORDER&nbsp;&nbsp;*** The Purchase Order consider accepted if there is no reply within 5 days ***<br /><br />
...
async function getMailpo(supp, tglawal, tglakhir, status)
{
  try
  {
    const response = await fetch(urlmailpotgl,
    {
      method:'POST',
      headers:{'Content-Type':'application/x-www-form-urlencoded'},
