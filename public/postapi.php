     ...
     // const alamat = 'https://svr1.jkei.jvckenwood.com/api/test.php'; // ganti sesuai alamat server Anda
      ...
      try {
        ...
        if (reply.includes('success')) {
          //const jawaban = reply.json_decode();

        const isidata = JSON.parse(reply);
        console.log(isidata);
        //console.log('Nama:', isidata.data.nama);
        //console.log('Level:', isidata.data.level);

        //const obj = JSON.parse(jsonString);

        console.log('userid : ' , isidata.data[0]);
        console.log('Level : ' , isidata.data[1]);

          console.log(reply);
          console.log('Login berhasil!');
          // misalnya redirect ke dashboard
